...
wait = {
    ...
    "Respontag":"Ngetag terus,,,ngasih gift jg kaga",
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🔰 " + key + " [TΣRXβΩTS🔀MΣΠU]🔰\n" + \
                  "🔰" + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "🔰" + key + "ɢɪɴғᴏ\n" + \
                  "🔰" + key + "ᴏᴘᴇɴ\n" + \
                  "🔰" + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "🔰🔰🔰「」↪  ʙʏ: тegυн s ↩ 🔰🔰🔰\n" + \
                  "🔀 Creator:  https://line.me/ti/p/~gerhanaselatan"
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴋᴀɴ ᴀɴɢɢᴏᴛᴀ ʙᴏᴛs ᴛᴇʀx")
#UPDATE FOTO
               if msg.contentType == 1:
                 if msg._from in admin:
                     ...
                     return
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"「ᴄʀᴇᴀᴛᴏʀ ʙᴏᴛs\nᴛᴇʀx-ʙᴏᴛs」") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
">>>lain x jangan sok songong ama kami>><\ningat  yee,,klo lu dendam cari kami\n<<<<<<<<<>>\nhttp://line.me/ti/p/~gerhanaselatan\nhttp://line.me/ti/p/~cyberline11")
                    ...
                    #    elif cmd == "terx.reinvite":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                ki.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                kk.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                kc.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                kb.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                kd.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                ke.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                kf.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                kj.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                                sw.sendMessage(msg.to, "◈T⃟E⃟R⃟X⃟B⃟O⃟T⃟S⃟◈")
                            #    cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========Hiburan============#
                          ...
                          if wait["selfbott"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                ki.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                kk.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                kc.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                kb.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                kd.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                ke.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                kf.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                kj.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                sw.sendMessage(msg.to, "тeaм тerXвoтѕ нadιr")
                                cl.sendMessage(msg.to, "тeaм тerXвoтѕ all ready\nAmankan Room\nDemi Amanatnya Bos ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.cancelGroupInvitation(,[Zmid])
                                cl.cancelGroupInvitation(,[Jmid])
